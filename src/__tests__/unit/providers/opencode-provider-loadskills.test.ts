/**
 * Test file: opencode-provider-loadskills.test.ts
 *
 * Purpose: Comprehensive tests for OpenCodeProvider loadSkills() method per P3.M2.T1.S4
 *
 * Tests:
 ...
 * - Error handling (descriptive errors with skill context)
 * - buildSystemPromptWithSkills() helper (all three cases)
...
describe('OpenCodeProvider - loadSkills()', () => {
