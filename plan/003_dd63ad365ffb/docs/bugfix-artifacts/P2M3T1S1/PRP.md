...
sed -n '775p' src/core/workflow.ts | grep -q "public setStatus"

# Example: Check snapshotState line number
sed -n '452p' src/core/workflow.ts | grep -q "public snapshotState"

# Example: Check attachChild line number
sed -n '334p' src/core/workflow.ts | grep -q "public attachChild"

# Example: Check detachChild line number
sed -n '397p' src/core/workflow.ts | grep -q "public detachChild"
